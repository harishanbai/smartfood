    ...
    <div className="min-h-screen pb-12">
          ...
          {foods.map(food => (
            ...
            >
              ...
              <div className="w-full h-[180px] rounded-2xl overflow-hidden bg-black/20 relative mb-3">
                {food.image ? (
                  <img src={food.image} alt={food.name} className="w-full h-full object-cover transition-transform duration-500 group-hover:scale-103" />
                ) : (
              ...
              <div className="pt-3 border-t border-white/5 flex items-center justify-between">
                ...
                <div className="flex items-center gap-1">
                  ...
                  <button
                    ...
                    className="p-2 rounded-xl text-gray-400 hover:text-red-500 hover:bg-red-500/5 transition-all cursor-pointer"
                  >
      ...
      {isModalOpen && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-center justify-center p-4 z-50 animate-fade-in">
          <div className="glass-panel w-full max-w-lg rounded-[24px] p-6 border border-white/10 relative shadow-2xl">
            <button
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="pt-4 flex gap-3 justify-end border-t border-white/5">
                <button
                  type="button"
                  onClick={() => setIsModalOpen(false)}
                  className="px-5 py-2.5 bg-white/5 hover:bg-white/10 border border-white/10 text-xs font-bold text-white rounded-xl transition-all cursor-pointer"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  className="px-5 py-2.5 bg-gradient-to-r from-accentPurple to-accentOrange text-xs font-bold text-white rounded-xl shadow-lg shadow-purple-500/10 transition-all cursor-pointer"
                >
