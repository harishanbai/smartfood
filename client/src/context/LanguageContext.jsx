...
const translations = {
  en: {
    ...
    ingredients: {
      ...
      lowStockSection: "LOW STOCK",
      lowStockSub: "Items below minimum threshold requiring attention",
      ...
      noLowStockItems: "No items currently low on stock.",
  ...
  ta: {
    ...
    ingredients: {
      ...
      noLowStockItems: "குறைந்த இருப்பில் உள்ள பொருட்கள் ஏதுமில்லை.",
